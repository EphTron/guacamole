  ...
  */
  ...
  class DynamicGeometry
  {
    public:
      ...
      DynamicGeometry( scm::gl::vertex_array_ptr const& a,
                 scm::gl::buffer_ptr const& v
               , scm::gl::buffer_ptr const& i)
               : vertex_array(a)
               , vertices(v)
               , vertex_topology(scm::gl::PRIMITIVE_LINE_LIST)
               , vertex_reservoir_size(0)
               , num_occupied_vertex_slots(0)
               , current_buffer_size_in_vertices(0)
      {}
  ...
  class DynamicTriangle
  {
    public:
      ...
      DynamicTriangle( scm::gl::vertex_array_ptr const& a,
                 scm::gl::buffer_ptr const& v
               , scm::gl::buffer_ptr const& i)
               : vertex_array(a)
               , vertices(v)
               , vertex_topology(scm::gl::PRIMITIVE_TRIANGLE_LIST)
               , vertex_reservoir_size(0)
               , num_occupied_vertex_slots(0)
               , current_buffer_size_in_vertices(0)
      {}
