...
namespace node {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  DynamicTriangleNode::DynamicTriangleNode(std::string const& name,
  ...
  */
  ...
  ////////////////////////////////////////////////////////////////////////////////
  /* virtual */ void DynamicTriangleNode::accept(NodeVisitor& visitor) {
    visitor.visit(this);
  }
  ...
  ////////////////////////////////////////////////////////////////////////////////
  std::shared_ptr<Node> DynamicTriangleNode::copy() const {
    return std::make_shared<DynamicTriangleNode>(*this);
  }
  ...
  void DynamicTriangleNode::push_vertex(DynamicTriangle::TriVertex const& dynamic_tri_vertex) {
    push_vertex(dynamic_tri_vertex.pos[0], dynamic_tri_vertex.pos[1], dynamic_tri_vertex.pos[2],
                dynamic_tri_vertex.col[0], dynamic_tri_vertex.col[1], 
                dynamic_tri_vertex.col[2], dynamic_tri_vertex.col[3],
                dynamic_tri_vertex.thick,
                dynamic_tri_vertex.uv[0], dynamic_tri_vertex.uv[1]);
  };

  ////////////////////////////////////////////////////////////////////////////////
  void DynamicTriangleNode::enqueue_vertex(float x, float y, float z,
  ...
  ////////////////////////////////////////////////////////////////////////////////
  void DynamicTriangleNode::push_vertex(float x, float y, float z,
                                  float col_r, float col_g, float col_b, float col_a,
                                  float thickness,
                                  float u, float v) {
    if(nullptr != geometry_) {
      DynamicTriangle::TriVertex vertex_to_push(x, y, z, 
