...
namespace node {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  DynamicGeometryNode::DynamicGeometryNode(std::string const& name,
  ...
  ////////////////////////////////////////////////////////////////////////////////
  std::string const& DynamicGeometryNode::get_geometry_description() const {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  std::shared_ptr<Material> const& DynamicGeometryNode::get_material() const {
    return material_;
  }
  ...
  void DynamicGeometryNode::ray_test_impl(Ray const& ray, int options,
  ...
  */
    ...
    if (geometry_changed_)
    {
      if (geometry_description_ != "")
      {
        if (!GeometryDatabase::instance()->contains(geometry_description_))
        {
          ...
          try {
            gua::DynamicGeometryLoader loader;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  std::shared_ptr<DynamicGeometryResource> const& DynamicGeometryNode::get_geometry() const {
    return geometry_;
  }

  ////////////////////////////////////////////////////////////////////////////////
  /* virtual */ void DynamicGeometryNode::accept(NodeVisitor& visitor) {
    visitor.visit(this);
  }
  ...
  void DynamicGeometryNode::push_vertex(DynamicGeometry::Vertex const& dynamic_geometry_vertex) {
    push_vertex(dynamic_geometry_vertex.pos[0], dynamic_geometry_vertex.pos[1], dynamic_geometry_vertex.pos[2],
                dynamic_geometry_vertex.col[0], dynamic_geometry_vertex.col[1], 
                dynamic_geometry_vertex.col[2], dynamic_geometry_vertex.col[3],
                dynamic_geometry_vertex.thick,
                dynamic_geometry_vertex.nor[0], dynamic_geometry_vertex.nor[1], dynamic_geometry_vertex.nor[2]);
  };

  ////////////////////////////////////////////////////////////////////////////////
  void DynamicGeometryNode::enqueue_vertex(float x, float y, float z,
  ...
  ////////////////////////////////////////////////////////////////////////////////
  void DynamicGeometryNode::push_vertex(float x, float y, float z,
                                  float col_r, float col_g, float col_b, float col_a,
                                  float thickness,
                                  float nor_x, float nor_y, float nor_z) {
    if(nullptr != geometry_) {
