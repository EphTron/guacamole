...
std::shared_ptr<PipelinePassDescription> DynamicTrianglePassDescription::make_copy() const {
  return std::make_shared<DynamicTrianglePassDescription>(*this);
}
