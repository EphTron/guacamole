...
std::shared_ptr<PipelinePassDescription> DynamicGeometryPassDescription::make_copy() const {
  return std::make_shared<DynamicGeometryPassDescription>(*this);
}
