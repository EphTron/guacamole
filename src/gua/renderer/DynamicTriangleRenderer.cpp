...
void DynamicTriangleRenderer::_create_physical_texture(gua::RenderContext const &ctx)
{
...
void DynamicTriangleRenderer::_apply_cut_update(gua::RenderContext const &ctx)
{
...
void DynamicTriangleRenderer::_collect_feedback(gua::RenderContext const &ctx)
{
